...
Dans le Noir? intensifies the problem. The guest does not know the exact dishes and cannot visually inspect them while eating.
...
Restaurant #16 uses booking to begin operational participation. The guest supplies information that affects preparation and service before arrival.
...
Dans le Noir? supplies direct contradiction evidence.
...
It must still capture allergies and specific dietary requirements.
...
The booker therefore acts as a proxy for other participants.
...
It is therefore consequence-relevant before commitment.
...
Dans le Noir? adds a further condition: the menu changes periodically and remains concealed from the guest during consumption.
...
Restaurant #16 contribution:

Very strong support across discovery, booking, disclosure, arrival, surrender, guide handoff, in-room communication, dietary reminder, completion, and reveal.
...
Very strong independent support. Stable participation contains a periodically changing and deliberately concealed menu.
...
Very strong support. The reservation makes the relationship among guest data, menu structure, guide roles, arrival procedure, and sensory conditions legible.

Boundary:

System legibility does not prove system performance.
...
Support plus one material contradiction: menu allocation at booking versus ordering on arrival.
...
Bounded support. Pre-commitment choice is visible; post-commitment flexibility remains unverified.
...
Strong support. Reservation prepares but does not replace reconfirmation, surrender, and human handoff.
...
Bounded support through real-time availability, party-size dependency, group escalation, and structured disclosure.
...
Strong contradiction and definition refinement.
...
Exceptionally strong support. Human assistance resolves booking exceptions and constitutes the physical hospitality product.
...
Support through available and full inventory states without visible urgency devices.
...
Strong support. The guest commits before outcome and exact product can be known; procedure and capacity carry pre-commitment confidence.
...
Strong support. Guest disclosure, reconfirmation, surrender, guide reliance, and conduct are operationally necessary.
...
Supporting. Standard dining remains structured while groups, private events, corporate events, linked reservations, and workshops route differently.
...
Insufficient. Direct booking is visible, but data ownership, portability, retention, and relationship control are unverified.
